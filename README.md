...
Lista Dinâmica: implementada com nós e referências.


Ambas já implementam os métodos básicos:

- exibir() (ou similar)
- adicionarElemento(String elemento)
- removerElemento(String elemento) (remove uma ocorrência)

O objetivo deste trabalho é comparar as duas listas adicionando novas funcionalidades, padronizadas por uma interface que não poderá ser modificada. Todas novas funcionalidades devem existir nas duas estruturas.

Seguem abaixo as descrições das interfaces com o uso de JavaDoc que devem ser aplicados em ambas as classes:
...
* OBS1: O trabalho pode ser feito, no máximo, em 5 pessoas.
* OBS2: Trabalhos copiados serão desconsiderados.
* OBS3: Atrasos serão descontados conforme alinhado no primeiro dia de aula.
* OBS4: Apenas um integrante pode fazer a entrega, desde que possua o nome dos demais integrantes. 

A entrega deve ser feita por meio de um repositório público no GitHub, com as modificações indicadas nesta atividade.
